...
type Repository interface {
	...
	ListFlashcardsForTag(ctx context.Context, tagID int64, userID int64) ([]FlashcardForTag, error)
...
type Service interface {
	...
	ListFlashcards(ctx context.Context, tagID int64, userID int64) (FlashcardsForTagResponse, error)
